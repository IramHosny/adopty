    ...
    <div className="dashboard">
      ...
      <div className="ui-row-2">
        ...
        <div className="main-content">
          <div className="header">
            ...
            <div className="clay-category">
              ...
              <p> Adoption requests for dogs</p>
            </div>
            <div className="clay-category">
          
              <p>Adoption requests for cats</p>
            
            </div>
            
          </div>
          <div className="large-banner">
            <h2>Working Together to Make Pets' Lives Brighter!</h2>
              ...
              <div>
                ...
                <div>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 49.382 49.382"
                    xmlSpace="preserve"
                  >
                    <g>
                      <path
                        d="M48.654,12.775c-0.333-1.618-1.912-2.886-3.594-2.886h-7.082c-0.159-3.128-0.308-5.418-0.308-5.418
		...
		c0.28,0,0.612,0.281,0.655,0.49c0.28,1.359,0.621,3.413,0.661,5.477C46.417,20.92,46.055,23.059,45.744,24.491z"
                ...
                <div>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 344.713 344.713"
                    xmlSpace="preserve"
                  >
                    <g>
                      <path
                        d="M190.028,70.017c0.06-0.669,0.095-1.345,0.095-2.029c0-12.498-10.133-22.631-22.631-22.631
		...
		C243.821,91.272,218.748,75.505,190.028,70.017z"
                      />
                      <path
                        d="M332.677,135.951c-8.831-9.86-21.559-15.291-35.84-15.291c-5.602,0-11.367,0.84-17.137,2.498
