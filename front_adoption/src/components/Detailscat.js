...
import AddadoptCat from './AddadoptCat';
...
console.log(cat)
  return (
    ...
    <img src={cat?.image} alt="" style={{ maxWidth: '500px', minWidth: '500px', maxHeight: '500px', minHeight: '500px', borderRadius: '5%' }} />
    <div style={{ marginLeft: '20px', display: 'flex', flexDirection: 'column' }}>
        ...
        <p style={{ maxWidth: '800px', minWidth: '800px', maxHeight: '400px', minHeight: '400px', fontStyle: 'italic', fontFamily: 'cursive', fontSize: '20px', fontWeight: 'bold' }} className='p_detail'> {cat?.description}
